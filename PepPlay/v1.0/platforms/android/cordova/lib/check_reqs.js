...
module.exports.check_android = function() {
    ...
    return d.promise.then(function(output) {
        if (!output.match(valid_target)) {
            return Q.reject(new Error(output + 'Please install Android target ' + valid_target.split('-')[1] + ' (the Android newest SDK). Make sure you have the latest Android tools installed as well. Run \"android\" from your command-line to install/update any missing SDKs or tools.'));
        }
        return Q();
    }, function(stderr) {
